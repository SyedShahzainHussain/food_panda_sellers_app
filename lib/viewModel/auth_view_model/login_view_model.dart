...
import 'package:driver_panda_app/widget/loading_dialog.dart';
      ...
      if (value != null || value.exists) {
        if (value.data()!["status"] == "approved") {
          ...
          await sharedPreferences!
              .setString("email", value.data()!["sellerEmail"]);
          await sharedPreferences!
              .setString("name", value.data()!["sellerName"]);
          await sharedPreferences!
              .setString("photoUrl", value.data()!["sellerAvatarUrl"]);
          Navigator.pop(context);
